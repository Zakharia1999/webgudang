                ...
                <div class="container">
                  <form action="<?= base_url('admin/proses_data_keluar') ?>" role="form" method="post">
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group" style="display:inline-block;">
                        <label for="jumlah_masuk" style="width:73%;margin-left:33px;">Jumlah</label>
                        <input type="number" name="jumlah_masuk" style="width:41%;margin-left:34px;margin-right:18px;" class="form-control" id="jumlah_masuk" max="<?= $d->jumlah_keluar ?>" value="<?= $d->jumlah_keluar ?>">
                      </div>
                    <?php } ?>
                    <!-- /.box-body -->
