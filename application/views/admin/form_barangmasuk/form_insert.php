          ...
          <div class="col-md-12">
            <div class="container">
              ...
              <div class="box box-primary" style="width:94%;">
                ...
                <!-- form start -->
                <div class="container">
                  <form action="<?= base_url('admin/proses_databarang_masuk_insert') ?>" role="form" method="post" autocomplete="off">
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group" style="display:inline-block;">
                        ...
                        <input type="number" name="jumlah_masuk" style="width:41%;margin-left:34px;margin-right:18px;" class="form-control" id="jumlah_masuk">
                      </div>
                      <div class="form-group" style="display:inline-block;">
