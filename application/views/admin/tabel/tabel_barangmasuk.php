          ...
          <div class="col-xs-12">
            ...
            <div class="box">
              ...
              <div class="box-body">
                ...
                <a href="<?= base_url('admin/cetak_qrcode') ?>" style="margin-bottom:10px;" type="button" class="btn btn-danger" target="_blank">
                    ...
                    <tr>
                      <?php if (is_array($list_data)) { ?>
                        ...
                        <?php foreach ($list_data as $dd) : ?>
                          ...
                          <td><img style="width: 100px;" src="<?php echo base_url() . 'assets/images/' . $dd->qr_code; ?>"></td>
