          ...
          <div class="col-xs-12">
            ...
            <div class="box">
              ...
              <div class="box-body">
                ...
                <a href="<?= base_url('report/barang_keluar_manual') ?>" target="_blank" style="margin-bottom:10px;" type="button" class="btn btn-danger" name="laporan_data"><i class="fa fa-file-text" aria-hidden="true"></i> Invoice Manual</a>
                <a href="<?= base_url('admin/scan_qrcode') ?>" style="margin-bottom:10px;" type="button" class="btn btn-success"><i class="fa fa-qrcode" aria-hidden="true"></i> Scan QR Code</a>
                    ...
                    <tr>
                      <?php if (is_array($list_data)) { ?>
                        ...
                        <?php foreach ($list_data as $dd) : ?>
                          ...
                          <td>
                            <img style="width: 100px;" src="<?php echo base_url() . 'assets/images/' . $dd->qr_code; ?>">
                          </td>
                          <td><a type="button" class="btn btn-danger btn-report" target="_blank" href="<?= base_url('report/barang_keluar/' . $dd->id_transaksi) ?>" name="btn_report" style="margin:auto;"><i class="fa fa-file-text" aria-hidden="true"></i></a></td>
                    </tr>
                    <?php $no++; ?>
                  <?php endforeach; ?>
                <?php } else { ?>
