        ...
        <aside class="main-sidebar">
            ...
            <li><a href="<?php echo base_url('admin') ?>"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
                    ...
                    <li class="treeview active">
                        ...
                        <ul class="treeview-menu">
                            <li class="active"><a href="<?= base_url('admin/laporan_masuk') ?>"><i class="fa fa-circle-o"></i> Report Barang </a></li>
                        </ul>
                        <!-- Source code Laporan -->
                    </li>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>Report</li>
                    <li class="active"><a href="<?= base_url('admin/tabel_barangkeluar') ?>">Form Report Barang</a></li>
                </ol>
            </section>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title"><i class="fa fa-table" aria-hidden="true"></i> Tabel Report Barang</h3>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="id_transaksi" style="margin-left:30%;display:inline;">ID Transaksi</label>
                                        <input type="text" name="id_transaksi" style="margin-left:37px;width:20%;display:inline;" class="form-control" placeholder="Klik Disini" ?>
                                    </div>
                                    <div class="box-footer">
                                        <button type="submit" style="margin-left:40%;width:20%;display:inline" class="btn btn-success"><i class="fa fa-check" aria-hidden="true"></i> Submit</button>
                                    </div>
                                            ...
                                            <tr>
                                                <?php if (is_array($list_data)) { ?>
                                                    ...
                                                    <?php foreach ($list_data as $dd) : ?>
                                                        ...
                                                        <td><?= $dd->satuan ?></td>
                                                        <td><?= $dd->jumlah_masuk ?></td>
                                                        <td><?= $dd->jumlah_keluar ?></td>
                                                        <td><a type="button" class="btn btn-danger btn-report" target="_blank" href="<?= base_url('report/barang/' . $dd->id_transaksi) ?>" name="btn_report" style="margin:auto;"><i class="fa fa-file-text" aria-hidden="true"></i></a></td>
                                            </tr>
                                            <?php $no++; ?>
                                        <?php endforeach; ?>
                                    <?php } else { ?>
